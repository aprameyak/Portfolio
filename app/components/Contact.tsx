...
const Contact = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="bg-surface rounded-xl p-8 hover-card transition-all duration-300">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4">
                ...
                <a href="mailto:aprameykannan@gmail.com" className="text-text hover:text-primary-light transition-colors duration-300">
                  aprameykannan@gmail.com
                </a>
              </div>
              <div className="flex items-center space-x-4">
                <svg className="w-6 h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-text">College Park, Maryland</span>
              </div>
            </div>
          </div>
