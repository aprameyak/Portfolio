          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <a href="mailto:aprameykannan@gmail.com" className="text-text-muted hover:text-primary-light transition-colors duration-300">
              ...
              >
                ...
                <span className="text-text-muted">College Park, Maryland</span>
              </motion.div>
            </div>
          </motion.div>
          <motion.div 
